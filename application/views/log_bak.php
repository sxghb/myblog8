<!--较为满意的登录界面，因不知其form、提交表单等怎样写，暂时搁置 2020.2.14-->
<?php
...
<div class="header" id="head">
    <div class="title">高平市党员档案管理系统</div>
...
<div class="footer" id="foot">
    <div class="copyright">
        <p>Copyright © 2018 gpzzb.com Inc. All Rights Reserved.</p>
        <div class="img">
            <i class="icon"></i><span>联系邮箱：gpzzbzzk@163.com</span>
        </div>

        <div class="img">
            <i class="icon1"></i><span>联系地址：高平市委组织部</span>
        </div>

        <div class="img">
            <i class="icon2"></i><span>联系电话：13835637076</span>
        </div>
