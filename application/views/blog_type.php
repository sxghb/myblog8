            ...
            <div id="AdminContent">
                <div class="MainForm BlogCatalogManage">
                    <form id="CatalogForm" action="admin/add_type" method="post">
                        ...
                        <span class="submit">
								<input id="tjid" value="添加&nbsp;»" tabindex="3" class="BUTTON SUBMIT" type="submit">
							</span>
                    </form>
                            ...
                            foreach ($types as $type){
                             ?>
                                <tr id="catalog_92334">
                                    ...
                                    <td class="opts">
                                        <a class="modify_type"   title="点击修改博客分类">修改</a>
...
<script>
    $('.delete-type').click(function () {//ID名前用#,类名前用.
...
<script>
    $('.modify_type').click(function () {//ID名前用#,类名前用.
        if(confirm('确定要修改该文章类型吗？')){
            document.getElementById("tjid").setAttribute("value", "修改 >>");
