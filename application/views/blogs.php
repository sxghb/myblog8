			...
			<div id="AdminScreen">
                ...
                <div id="AdminContent">
					<div class="MainForm BlogArticleManage">
						<h3 class="title">共有<?php echo $num_rows;?>篇博客，每页显示 40 个，共 1 页</h3>
						<div id="BlogOpts">
							<a href="javascript:;" id="select_all">全选</a>&nbsp;|
							<a href="javascript:;" id="unselect_all">取消</a>&nbsp;|
							<a href="javascript:;" id="select_other">反向选择</a>&nbsp;|
							<a href="javascript:;" id="btselect_alln-selected">删除选中</a>
						</div>
						<ul>
                            <?php
                            ...
                            ?>
                                     <li id="row_1">
                                        <input name="blog_id" value="<?php echo $blog->blog_id;?>" type="checkbox" class="selected">
...
<script>
    ...
    $('#select_other').click(function(){//该功能调试有问题，不知何故
        $("#row_1:checkbox").each(function() {
